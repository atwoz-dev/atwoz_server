...
public class ProfileExchangeRejectedMessageTemplate implements MessageTemplate {

    private final MemberCommandRepository memberCommandRepository;

    @Override
    public NotificationType getNotificationType() {
        return NotificationType.PROFILE_EXCHANGE_REJECTED;
    }
    ...
    public String getTitle(MessageTemplateParameters parameters) {
        ...
        return receiver.getProfile().getNickname() + "님이 프로필 교환을 거절하셨습니다.";
    }
