...
import deepple.deepple.admin.command.domain.suspension.MemberSuspendedEvent;
import deepple.deepple.admin.command.domain.suspension.MemberUnsuspendedEvent;
