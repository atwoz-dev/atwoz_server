...
class TokenFilterTest {
    ...
    void shouldReturnUnauthorizedWhenAccessTokenIsExpiredButRefreshTokenIsMissing()
    ...
    void shouldReturnUnauthorizedWhenAccessTokenIsExpiredButRefreshTokenIsInvalid()
        throws IOException, ServletException {
        // given
        when(request.getRequestURI()).thenReturn(PROTECTED_PATH);
        when(pathMatcherHelper.isExcluded(PROTECTED_PATH)).thenReturn(false);
